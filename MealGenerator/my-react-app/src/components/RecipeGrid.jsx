...
export default function RecipeGrid({ ingredients, allRecipes, isSearching, onRecipeClick, loadingText, onSearch }) {
        ...
        <div className="bg-gray-900/50 rounded-3xl border border-gray-700 p-4 md:p-6 shadow-lg shadow-[#ce7c1c]/10 hover:shadow-[#ce7c1c]/20 transition-all duration-300 h-full flex flex-col">
            ...
            {isSearching ? (
                <div className="flex flex-col items-center justify-center py-6 md:py-8 flex-grow min-h-[300px]">
                    ...
                    <p className="text-gray-400 font-terminal text-xs md:text-sm">{loadingText || "Finding recipes..."}</p>
                </div>
            ) : ingredients.length === 0 ? (
                <div className="text-center py-6 md:py-8 flex-grow min-h-[300px]">
                    <p className="text-gray-400 font-terminal text-xs md:text-sm">Add ingredients to discover recipes</p>
                </div>
            ) : allRecipes.length === 0 ? (
                <div className="text-center py-6 md:py-8 flex-grow min-h-[300px]">
                ...
                <div className="mb-4 flex-grow overflow-hidden">
                    ...
                    <div className="mt-4">
                        <Button
                            className="w-full border border-[#ce7c1c] bg-[#ce7c1c]/10 hover:bg-[#ce7c1c]/30 text-[#ce7c1c] px-4 py-2 font-terminal rounded-full cursor-pointer text-sm md:text-base font-bold shadow-md shadow-[#ce7c1c]/10 hover:shadow-[#ce7c1c]/30 transform hover:scale-105 transition-all duration-300"
                            onClick={onSearch}
